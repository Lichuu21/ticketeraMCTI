...
class TableroUsuarioInline(admin.TabularInline):
...
class TableroUsuarioAdmin(admin.ModelAdmin):
    ...
    search_fields = ['usuario__email', 'usuario__nombre', 'tablero__nombre']
    autocomplete_fields = ['tablero', 'usuario']

    def has_module_permission(self, request):
        return False   # lo oculta del sidebar de Jazzmin
@admin.register(Ticket)
class TicketAdmin(admin.ModelAdmin):
    list_display = ['titulo', 'tablero', 'estado', 'prioridad', 'fecha_creacion']
    list_filter = ['estado', 'prioridad', 'tablero']
    search_fields = ['titulo']
    autocomplete_fields = ['tablero']
...
class NotificacionAdmin(admin.ModelAdmin):
    ...
    list_filter = ['leida']
    autocomplete_fields = ['usuario', 'ticket']
