...
urlpatterns = [
    ...
    path('tickets/rename-column/', views.rename_column_view, name='tickets-rename-column'),
    path('tickets/move-orphan/', views.move_orphan_tickets_view, name='tickets-move-orphan'),
    path('tablero-usuarios/remove-member/', views.remove_member_view, name='tablero-usuarios-remove-member'),
